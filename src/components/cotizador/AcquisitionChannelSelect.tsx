...
import { ACQUISITION_CHANNELS, ACQUISITION_CHANNEL_LABEL, type AcquisitionChannel } from "@/lib/acquisition-channel";
  ...
  return (
    <div className="space-y-2">
      <div className="flex items-center gap-2">
        ...
        <h3 className="font-semibold text-brand-ink text-sm">How did you hear about us? *</h3>
      </div>
      <select
