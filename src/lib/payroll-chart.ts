 ...
 * of Accounts base del Financial Ledger. Cada cuenta es un código en formato
 * X-XXXX que se usa en los Journal Entries de nómina.
 *
 * Pasivos (2xxx):
 *   - 2-2200: CPP por Pagar (employee + employer)
 *   - 2-2300: EI por Pagar (employee + employer)
 *   - 2-2400: Impuestos Retenidos por Pagar (federal + provincial)
 *   - 2-2500: WorkSafeBC por Pagar
 *   - 2-2600: Vacation Pay Acumulado (pasivo)
 *
 * Gastos (6xxx):
