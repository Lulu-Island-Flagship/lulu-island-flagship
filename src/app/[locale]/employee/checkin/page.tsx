 ...
 * (/api/employee/checkin) ya existían; esta pantalla era la única pieza que
...
export default function CheckinPage() {
  ...
  async function load() {
    setLoading(true);
    try {
      const res = await fetch("/api/employee/checkin", { credentials: "include" });
      if (res.ok) {
  ...
  async function toggleOptOut() {
    ...
    try {
      const res = await fetch("/api/employee/wellbeing-optout", {
        method: "PATCH",
        headers: { "Content-Type": "application/json" },
        credentials: "include",
  ...
  async function reportShortcut() {
    ...
    try {
      const res = await fetch("/api/employee/route-shortcuts", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        credentials: "include",
