 ...
 * servicio -- solo existía /api/employee/appeal, y ese es exclusivamente
...
export async function POST(request: NextRequest) {
  try {
    ...
    // guard que /api/employee/upsells, evita que alguien dispute horas de un
    // servicio ajeno.
...
// GET /api/employee/hours-dispute?orderId=... — historial propio de disputas de T
