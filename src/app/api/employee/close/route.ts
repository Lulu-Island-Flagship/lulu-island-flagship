...
// GET /api/employee/close?orderId=... — estado actual del cierre (para la UI)
...
// POST /api/employee/close — confirma implementos y/o confirmación externa
// para el Protocolo de Cierre Externo (E4.11). No cierra el servicio por sí
// mismo — T_out (en /api/employee/service) es el que evalúa el protocolo
